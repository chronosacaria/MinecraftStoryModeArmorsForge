...
public class WhitePumpkinBlock extends StemGrownBlock {
        ...
        if (itemstack.getItem() == Items.SHEARS) {
            if (!worldIn.isRemote) {
                ...
                worldIn.setBlockState(pos,
                        BlockRegistry.CARVED_WHITE_PUMPKIN.get().getDefaultState().with(CarvedWhitePumpkinBlock.FACING, direction1),
                        11);
